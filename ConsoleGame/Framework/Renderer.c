...
int s_backBufferIndex; // 현 화면이 아닌 back buffer을 저장할 변수
...
void Renderer_clear(void) // 백 버퍼의 화면을 클리어 해주는 함수
{
	HANDLE consoleHandle = s_screens[s_backBufferIndex]; //백 버퍼를 대상으로 클리어
